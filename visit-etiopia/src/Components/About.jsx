...
export default function About(){
    return(
       ...
       <br /> <br /> <span>History and Civilization</span> <br /> 
        Ethiopia has a deep historical legacy, claiming one of the oldest continuous civilizations in the world. The ancient city of Aksum was the capital of the Aksumite Empire, known for its obelisks and connections to the Queen of Sheba. Lalibela is famous for its rock-hewn churches, while Gondar boasts medieval castles and palaces.
        
       <br /> <br /> <span>Culture and Ethnic Diversity</span> <br /> 
        Ethiopia is home to a multitude of ethnic groups, each with its own unique language, customs, and traditions. The Omo Valley, in particular, is a cultural melting pot, where various tribes, such as the Hamar, Mursi, and Karo, reside. Traditional music, dance, and religious ceremonies are integral parts of Ethiopian culture.
        
       <br /> <br /> <span>Religious Heritage</span> <br /> 
        Ethiopia is one of the earliest regions to adopt Christianity, and it has a rich religious heritage. The Ethiopian Orthodox Tewahedo Church has played a significant role in shaping the country's identity. The city of Lalibela is a pilgrimage site, and monasteries on Lake Tana showcase the religious history of the country.
        
       <br /> <br /> <span>Natural Wonders</span> <br /> 
        The country is endowed with breathtaking natural wonders. Lake Tana, the largest lake in Ethiopia, is dotted with monasteries. The Blue Nile Falls, in the vicinity, is a spectacular waterfall. The Danakil Depression, one of the hottest places on Earth, features colorful hot springs and salt flats.
        
       <br /> <br /> <span>Modern Capital</span> <br />  
